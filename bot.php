      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/llop12b/2",
                   'caption'=>'تمت البرمجه بواسطه (@div0m) 💻',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'تسجيل حساب وهمي في البوت 🏃‍♂','callback_data'=>'login']],
                       [['text'=>"قناة نشر صيد المشتركين 🔥", 'url'=>"https://t.me/Safwanexpert"]],
                      ]
                  ])
              ]);   
...
لشراء نسخه مراسلةة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| 𝑫𝒊𝒗0𝒎','url'=>'t.me/div0m']],
                       [['text'=>"▪️| قناه صيد المشتركين", 'url'=>"t.me/Safwanexpert"]],
                      ]
                  ])
              ]);   
				}
